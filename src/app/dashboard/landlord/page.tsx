...
import { Plus, Pencil, Trash2, Home, ClipboardList, LogOut, Menu } from 'lucide-react';
  ...
  const SidebarContent = () => (
    <>
      ...
      <nav className="flex-1 p-4 space-y-1">
        ...
        <Link href="/dashboard/landlord/requests" onClick={() => setSidebarOpen(false)} className="flex items-center gap-3 px-3 py-2 rounded-lg text-sm text-gray-700 hover:bg-blue-50 hover:text-blue-600 transition">
    ...
    <div className="min-h-screen flex bg-gray-50">
      ...
      <main className="flex-1 min-w-0 overflow-y-auto">
        ...
        <div className="md:hidden flex items-center gap-3 px-4 py-3 bg-white border-b border-gray-200 sticky top-0 z-30">
          ...
          <span className="font-semibold text-gray-900">Landlord Dashboard</span>
        </div>
