...
import { ArrowLeft, CheckCircle, XCircle, LogOut, Home, ClipboardList } from 'lucide-react';
    ...
    <div className="min-h-screen flex bg-gray-50">
      ...
      <aside className="w-64 bg-white border-r border-gray-200 flex flex-col">
        ...
        <nav className="flex-1 p-4 space-y-1">
          ...
          <Link href="/dashboard/landlord" className="flex items-center gap-3 px-3 py-2 rounded-lg text-sm text-gray-700 hover:bg-blue-50 hover:text-blue-600 transition">
            <Home size={16} /> My Properties
          </Link>
          <Link href="/dashboard/landlord/requests" className="flex items-center gap-3 px-3 py-2 rounded-lg text-sm bg-blue-50 text-blue-600 font-medium">
